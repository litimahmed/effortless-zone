...
import { TYPE_PARTENAIRE_OPTIONS } from "@/types/partner";
import { 
  Building2,
  Phone, 
  Mail, 
...
export default function PartnerCreate() {
  ...
  const handleChange = (field: keyof PartnerPayload, value: string | boolean | number) => {
    setFormData(prev => ({
      ...prev,
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="shadow-elegant">
            <CardHeader>
              ...
              <CardDescription>Partner details and contact information</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="nom_partenaire">Partner Name *</Label>
                <Input
                  id="nom_partenaire"
                  required
